...
import static org.springframework.data.mongodb.core.aggregation.Aggregation.*;//STATIC IMPORT!
import org.springframework.stereotype.Repository;

import telran.spring.accounting.entities.AccountEntity;

@Repository
public class AccountAgrigationRepositoryImpl implements AccountAggregationRepository {
